...
public interface GraphADT<NodeType, EdgeType extends Number> {
     ...
     */
    boolean insertNode(NodeType data);
     ...
     * @throws NullPointerException if data is null
     */
    boolean removeNode(NodeType data);
     ...
     *         false otherwise
     */
    boolean containsNode(NodeType data);
     ...
     * 
     * @param pred   is the data item contained in the new edge's pred node
     ...
     */
    boolean insertEdge(NodeType pred, NodeType succ, EdgeType weight);
     ...
     */
    boolean removeEdge(NodeType pred, NodeType succ);
     ...
     */
    boolean containsEdge(NodeType pred, NodeType succ);
     ...
     */
    EdgeType getEdge(NodeType pred, NodeType succ);
     ...
     */
    List<NodeType> shortestPathData(NodeType start, NodeType end);
     ...
     */
    double shortestPathCost(NodeType start, NodeType end);
}
