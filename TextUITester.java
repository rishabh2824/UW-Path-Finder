...
public class TextUITester {
    ...
    // checkOutput() method is used int the example above.

    private final PrintStream saveSystemOut; // store standard io references to restore after test
    private final PrintStream saveSystemErr;
    private final InputStream saveSystemIn;
    private final ByteArrayOutputStream redirectedOut; // where output is written to during the test
